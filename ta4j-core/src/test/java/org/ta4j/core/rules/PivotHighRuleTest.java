...
public class PivotHighRuleTest extends AbstractIndicatorTest<BarSeries, Num> {

    private BarSeries series;
    private PivotHighRule rule;

    public PivotHighRuleTest(NumFactory numFactory) {
        super(numFactory);
    }
    ...
    public void setUp() {
        ...
        rule = new PivotHighRule(new HighPriceIndicator(series), 1, 1);
    }
